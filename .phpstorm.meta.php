...
'filesystems.disks.s3.report','filesystems.links./app/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'sanctum.middleware.validate_csrf_token','sanctum.prefix','services.postmark.token','services.resend.key','services.ses.key',
...
'ziggy.middleware','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables','data.features.ignore_exception_when_trying_to_set_computed_property_value',
...
'data.livewire.enable_synths','typescript-transformer.auto_discover_types','typescript-transformer.collectors','typescript-transformer.transformers','typescript-transformer.default_type_replacements.DateTime',
...
'typescript-transformer.writer','typescript-transformer.formatter','typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','structure-discoverer.ignored_files',
...
'password.confirm.store','sanctum.csrf-cookie','index',
'storage.local',);
        registerArgumentsSet('views', 
'index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
